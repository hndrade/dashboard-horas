...
if uploaded_file:
    ...
    if df_filtrado.empty:
        ...
        # Seletor de data início e término (usando objetos datetime, não strings)
        data_inicio_cumprimento = st.date_input("Data Início", periodo_inicio_cumprimento.date())
        data_termino_cumprimento = st.date_input("Data Término", periodo_termino_cumprimento.date())
